      ...
      <motion.div variants={itemVariants}>
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Personal Information Card (merged with Account Information) */}
              <Card className="overflow-hidden">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div><CardTitle className="text-base font-semibold">Personal Information</CardTitle><CardDescription className="text-xs mt-0.5">Your account details and login information</CardDescription></div>
                    </div>
                ...
                <CardContent className="pt-0">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 p-2.5 rounded-lg bg-muted/30"><div className="h-8 w-8 rounded-md bg-background flex items-center justify-center flex-shrink-0"><Mail className="h-4 w-4 text-muted-foreground" /></div><div className="flex-1 min-w-0"><p className="text-[11px] text-muted-foreground">Email Address</p><div className="flex items-center gap-2"><p className="text-sm font-medium text-foreground truncate">{profile.email}</p><Lock className="h-3 w-3 text-muted-foreground/50 flex-shrink-0" /></div></div></div>
                    ...
                    {/* Account details (merged from Account Information) */}
                    <div className="pt-2 border-t border-border/40">
                      <p className="text-[10px] uppercase tracking-wider text-muted-foreground/70 font-semibold mb-2">Account Details</p>
                    </div>
                    <div className="flex items-center gap-3 p-2.5 rounded-lg bg-muted/30"><div className="h-8 w-8 rounded-md bg-background flex items-center justify-center flex-shrink-0"><Store className="h-4 w-4 text-muted-foreground" /></div><div className="flex-1 min-w-0"><p className="text-[11px] text-muted-foreground">Store Name</p><div className="flex items-center gap-2"><p className="text-sm font-medium text-foreground truncate">{profile.storeName}</p><Lock className="h-3 w-3 text-muted-foreground/50 flex-shrink-0" /></div></div></div>
                    <div className="flex items-center gap-3 p-2.5 rounded-lg bg-muted/30"><div className="h-8 w-8 rounded-md bg-background flex items-center justify-center flex-shrink-0"><Shield className="h-4 w-4 text-muted-foreground" /></div><div className="flex-1 min-w-0"><p className="text-[11px] text-muted-foreground">Account Status</p><div className="flex items-center gap-2"><div className={cn('h-2 w-2 rounded-full', profile.status === 'Active' ? 'bg-emerald-500' : profile.status === 'Blocked' ? 'bg-red-500' : 'bg-amber-500')} /><p className="text-sm font-medium text-foreground">{profile.status}</p>{profile.isVerified && <Badge className="gap-1 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 px-2 py-0 h-5 text-[10px]">Verified</Badge>}</div></div></div>
                    ...
                    {/* Info note */}
                    <div className="flex items-start gap-2.5 p-3 rounded-lg bg-amber-50/50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30"><Info className="h-4 w-4 text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" /><p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">To change your email or store name, please contact support. You can update your name and phone number using the Edit button.</p></div>
                  </div>
                </CardContent>
              </Card>
