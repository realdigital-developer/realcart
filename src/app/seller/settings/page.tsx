            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <CardDescription className="text-xs mt-0.5">Your account details and login information</CardDescription>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/30">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-sm font-medium text-foreground truncate">{profile.storeName}</p>
                    <Lock className="h-3 w-3 text-muted-foreground/50 flex-shrink-0" />
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <div className={cn(
                      ...
                      profile.status === 'Active' ? 'bg-emerald-500' : profile.status === 'Blocked' ? 'bg-red-500' : 'bg-amber-500'
                    )} />
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/30">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm font-medium text-foreground">{formatDateTime(profile.lastLoginAt)}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5 p-3 rounded-lg bg-amber-50/50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30">
                ...
                <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">
                  To change your email or store name, please contact support. You can update your profile details from the{' '}
                  <Link href="/seller/profile" className="underline font-medium hover:text-amber-600">Profile page</Link>.
                </p>
              </div>
            </div>
          </CardContent>
