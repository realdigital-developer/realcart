...
export default function SellerProductsPage() {
    ...
    return (
      ...
      >
        <Card className="overflow-hidden hover:shadow-lg hover:border-emerald-200 dark:hover:border-emerald-900/50 transition-all duration-200 group py-0 gap-0 h-full flex flex-col">
          <div className="relative w-full bg-muted flex-shrink-0 overflow-hidden" style={{ height: '0', paddingBottom: '100%' }}>
            <img src={primaryImg} alt={product.name} className="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-300" />
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      ...
      {/* ================================================================ */}
      {/*  CATEGORY FILTER MODAL — Two-panel layout like customer panel    */}
      {/* ================================================================ */}
      ...
      >
        <div className="flex min-h-[300px] -mx-1">
