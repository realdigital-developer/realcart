                ...
                {step === 'otp' && (
                  <div className="space-y-5">
                    <div className="space-y-3">
                      ...
                      <button onClick={() => { setBindingCode(''); setOtp(''); goToStep('mobile') }} className="w-full text-center text-sm text-muted-foreground hover:text-foreground flex items-center justify-center gap-1">
